...
public class PassengersController {
    ...
    public static void AddNewPassenger(Database database, Scanner s) throws SQLException {
        ...
        String insert = "INSERT INTO `passengers`(`id`, `firstName`, `lastName`, `tel`, `email`) " +
                "VALUES ('"+p.getId()+"','"+p.getFirstName()+"','"+p.getLastName()+"','"+p.getTel()+"','"+p.getEmail()+"')";
    ...
    public static void EditPassenger(Database database, Scanner s) throws SQLException{
        ...
        String update = "UPDATE `passengers` SET `id`='"+ passenger.getId()+"',`firstName`='"+passenger.getFirstName()+"',`lastName`='"+passenger.getLastName()+"'" +
                ",`tel`='"+passenger.getTel()+"',`email`='"+passenger.getEmail()+"' WHERE `id` = '"+passenger.getId()+"';";
        database.getStatement().execute(update);
        System.out.println("Passenger edit successfully!");
    ...
    public static void findPassengerByName(Database database, Scanner s) throws SQLException{
        ...
        String get = "SELECT `id`, `firstName`, `lastName`, `tel`, `email` FROM `passengers` WHERE `fistName` = \""+firstName+"\";";
        ResultSet rs = database.getStatement().executeQuery(get);
